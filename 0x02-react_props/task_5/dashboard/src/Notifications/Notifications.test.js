...
const listNotifications = [
  ...
  { id: 2, type: "urgent", value: "New resumt available" },
...
describe("Notification tests", () => {
  ...
  it('renders "No new notification for now" instead of "Here is the list of notifications" when listNotification is empty', () => {
    const wrapper = shallow(<Notifications displayDrawer={true} listNotifications={[]} />);
