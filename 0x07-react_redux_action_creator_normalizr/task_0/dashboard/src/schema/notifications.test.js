...
describe("Test for Notifications.js", () => {
    it("verify that the function returns the correct data", () => {
      ...
      it("should have a correct messages entity", () => {
        ...
        expect(normalized.entitites.messages["efb6c485-00f7-4fdf-97cc-5e12d14d6c41"].toEqual(message));
      });
      ...
      it("should have a correct notifications entity", () => {
        ...
        expect(normalized.entities.notification["5debd764f8452ef92346c772"]).toEqual(notificationDummy);
      });
});